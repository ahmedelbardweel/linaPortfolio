        ...
        @forelse ($tips as $tip)
            <div class="rounded-[3px] p-4 bg-white dark:bg-[#161615] border border-[#e3e3e0] dark:border-[#3E3E3A] transition-transform duration-300 hover:-translate-y-1 flex flex-col">
                <div class="flex items-center justify-between mb-2">
                    <span class="inline-block px-2 py-0.5 rounded text-[10px] font-medium text-white" style="background:#f53003">{{ $tip->category ?? 'Uncategorized' }}</span>
                ...
                <div class="flex items-center justify-between mt-3 pt-3 border-t border-[#e3e3e0] dark:border-[#3E3E3A]">
                    ...
                    <div class="flex items-center gap-1">
                        <a href="{{ route('admin.tips.edit', $tip) }}" class="inline-flex items-center justify-center w-7 h-7 rounded text-[#c42802] hover:text-[#f53003] hover:bg-[#f0f0ef] dark:hover:bg-[#2a2a28] transition-all" title="Edit">
