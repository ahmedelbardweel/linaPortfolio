...
@section('content')
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC]">Settings</h1>
        <p class="mt-1 text-sm text-[#706f6c]">Manage your site-wide settings and configuration.</p>
    </div>
    ...
    <div class="max-w-2xl">
        <form method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data" class="bg-white dark:bg-[#161615] rounded-xl shadow-sm border border-[#e3e3e0] dark:border-[#3E3E3A] p-6 space-y-6">
            ...
            <h2 class="text-lg font-semibold text-[#1b1b18] dark:text-[#EDEDEC] pb-2 border-b border-[#e3e3e0] dark:border-[#3E3E3A]">General</h2>
            ...
            {{-- Logo --}}
            <div>
                <label for="logo" class="block text-sm font-medium text-[#1b1b18] dark:text-[#EDEDEC] mb-1">Logo</label>
                @isset($settings['logo'])
                    <div class="mb-2">
            ...
            <h2 class="text-lg font-semibold text-[#1b1b18] dark:text-[#EDEDEC] pb-2 border-b border-[#e3e3e0] dark:border-[#3E3E3A] pt-4">Hero Section</h2>
            ...
            {{-- Hero Image --}}
            <div>
                <label for="hero_image" class="block text-sm font-medium text-[#1b1b18] dark:text-[#EDEDEC] mb-1">Hero Image</label>
            ...
            <h2 class="text-lg font-semibold text-[#1b1b18] dark:text-[#EDEDEC] pb-2 border-b border-[#e3e3e0] dark:border-[#3E3E3A] pt-4">Social & Contact</h2>
